...
<head>
    ...
    <title>ODLines - XbsjEarth Documentation</title>
...
<header>
        ...
        <div class="class-description">ODLines用于展示OD线集合</div>
...
<article>
    ...
    <h4 class="name" id="ODLines">
        <a href="#ODLines" class="doc-link"></a>
        new Obj.ODLines<span class="signature">()</span>
...
<h4 class="name" id="currentTime">
    ...
    currentTime<span class="type-signature"> : number</span>
...
<h4 class="name" id="data">
    ...
    data<span class="type-signature"> : Array.&lt;object></span>
...
<div class="nameContainer">
<h4 class="name" id="timeDuration">
    <a href="#timeDuration" class="doc-link"></a>
    timeDuration<span class="type-signature"> : number</span>
...
<div class="nameContainer">
<h4 class="name" id="translucentPass">
    <a href="#translucentPass" class="doc-link"></a>
    translucentPass<span class="type-signature"> : boolean</span>
