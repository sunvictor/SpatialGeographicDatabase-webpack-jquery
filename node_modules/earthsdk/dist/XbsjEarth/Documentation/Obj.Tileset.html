...
<article>
    ...
    <h4 class="name" id="Tileset">
        ...
        new Obj.Tileset<span class="signature">()</span>
...
<div class="nameContainer">
<h4 class="name" id="xbsjMaxViewDistance">
    <a href="#xbsjMaxViewDistance" class="doc-link"></a>
    xbsjMaxViewDistance<span class="type-signature"> : number</span>
...
<div class="nameContainer">
<h4 class="name" id="xbsjMinViewDistance">
    <a href="#xbsjMinViewDistance" class="doc-link"></a>
    xbsjMinViewDistance<span class="type-signature"> : number</span>
