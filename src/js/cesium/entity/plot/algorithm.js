import {P} from "@/js/cesium/entity/plot/plotUtil";
...
xp.algorithm = {},
    xp.algorithm.doubleArrow = function (inputPoint) {
        ...
        if (!(2 > t)) {
            ...
            let d = P.PlotUtils.getBezierPoints(h.concat(a.slice(1)));
            u = P.PlotUtils.getBezierPoints(u);
            let f = c.concat(p, d, l, u);
            let newArray = xp.algorithm.array2Dto1D(f);
