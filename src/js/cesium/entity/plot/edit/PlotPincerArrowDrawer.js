...
export default class PlotPincerArrowDrawer {
    ...
    showModifyPincerArrow(custom, oldParams, okHandler, cancelHandler) {
        let _this = this;
        let arr = [];
        ...
        _this.shapeColor = _this.params.color; // 更新数据
    ...
    _createToolBar() {
        ...
        //     '    </div>' +
        //     '</div>';
//         let html = `<div id="shapeEditContainer" style="color:black; height:300px;width:400px">
//         <div id="shapeEditRTCorner">钳击箭头</div>
//         <hr>
//         <div>
//             <label>名称:</label><input id="pincerArrowName" type="text" value="钳击箭头"/>
//             </div>
//             <div>
//             <!-- <label>贴地</label> -->
...
//             <!-- <label>米</label> -->
//             <label>颜色</label>
//             <span class="pincerArrow-shapecolor-paigusu" style="width:25px;height:25px;background:rgba(228,235,41,1.0);display:inline-block;margin:0;"></span>
//             <label>边框颜色</label>
//             <span class="pincerArrow-border-paigusu" style="width:25px;height:25px;background:rgba(38,57,167,1.0);display:inline-block;margin:0;"></span>
//             </div>
...
<div style="margin-left: 10%; margin-top: 5%;">
    ...
    width: 200px;
    height: 25px;
    text-indent: 10px;outline:none; border:none;" id="pincerArrowName" type="text" value="钳击箭头"/>
    </div>
    <div style="margin-left: 10%; margin-top: 5%;">
    <!-- <label>贴地</label> -->
    <!-- <input id="clamp" type="checkbox" name="clamp" checked> -->
    ...
    <span class="pincerArrow-shapecolor-paigusu" style="width:25px;height:25px;background:rgba(228,235,41,1.0);display:inline-block;"></span>
    <label style="top: 50.5%; left: 32%;">边框颜色：</label>
    <span class="pincerArrow-border-paigusu" style="width:25px;height:25px;background:rgba(38,57,167,1.0);display:inline-block;"></span>
    </div>
   <!-- <div><label>边框宽度</label><input id="outlineWidth" type="range" min="1" max="100" step="1"/></div> -->
<div style="position: absolute;bottom: 10px;right: 10px;" class="layerBtn">
<button name="btnOK" class="layui-btn layui-btn-xs layui-btn-normal"> 确定 </button>
...
`
    ...
    setAttribute() {
        ...
        // 设置图形颜色
        // $(".pincerArrow-shapecolor-paigusu").paigusu({
        ...
        // 设置边框颜色
        // $(".pincerArrow-border-paigusu").paigusu({
        ...
        // 修改图形名称
        $('#pincerArrowName').bind('input propertychange', function () {
            let val = $("#pincerArrowName").val();
            _this.shapeName = val;
        })
    ...
    initPanelData() {
        let _this = this;
        $("#pincerArrowName").val(_this.shapeName); // 设置面板中的图形名称
        // $("#clamp").
        ...
        $(".pincerArrow-shapecolor-paigusu").css("background", _this.shapeColor); //  设置图形颜色span的背景色
        $(".pincerArrow-border-paigusu").css("background", _this.outlineColor); //  设置边框颜色span的背景色
    }
